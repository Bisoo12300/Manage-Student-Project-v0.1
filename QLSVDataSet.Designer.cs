...
namespace QLSV {
    ...
    public partial class QLSVDataSet : global::System.Data.DataSet {
        ...
        public partial class courseDataTable : global::System.Data.TypedTableBase<courseRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public courseRow AddcourseRow(string id, string label, int period, string semester, string description) {
...
namespace QLSV.QLSVDataSetTableAdapters {
    ...
    public partial class courseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[course] WHERE (([id] = @Original_id) AND ([label] = @Original_label) AND ([period] = @Original_period) AND ([semester] = @Original_semester) AND ((@IsNull_description = 1 AND [description] IS NULL) OR ([description] = @Original_description)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[course] ([id], [label], [period], [semester], [description]) V" +
                "ALUES (@id, @label, @period, @semester, @description);\r\nSELECT id, label, period" +
                ", semester, description FROM course WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[course] SET [id] = @id, [label] = @label, [period] = @period, [semester] = @semester, [description] = @description WHERE (([id] = @Original_id) AND ([label] = @Original_label) AND ([period] = @Original_period) AND ([semester] = @Original_semester) AND ((@IsNull_description = 1 AND [description] IS NULL) OR ([description] = @Original_description)));
SELECT id, label, period, semester, description FROM course WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, label, period, semester, description FROM dbo.course";
        ...
        public virtual int Delete(string Original_id, string Original_label, int Original_period, string Original_semester, string Original_description) {
            if ((Original_id == null)) {
        ...
        public virtual int Insert(string id, string label, int period, string semester, string description) {
            if ((id == null)) {
        ...
        public virtual int Update(string id, string label, int period, string semester, string description, string Original_id, string Original_label, int Original_period, string Original_semester, string Original_description) {
            if ((id == null)) {
                throw new global::System.ArgumentNullException("id");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string label, int period, string semester, string description, string Original_id, string Original_label, int Original_period, string Original_semester, string Original_description) {
            return this.Update(Original_id, label, period, semester, description, Original_id, Original_label, Original_period, Original_semester, Original_description);
        }
    }
